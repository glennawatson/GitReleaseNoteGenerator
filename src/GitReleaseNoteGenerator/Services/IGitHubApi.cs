...
{
    /// <summary>Gets a repository, used to resolve the default branch as the comparison head.</summary>
    ...
    /// <summary>Gets the latest published release, used to resolve the base ref when none is supplied.</summary>
    /// <param name="owner">The repository owner.</param>
    /// <param name="repo">The repository name.</param>
