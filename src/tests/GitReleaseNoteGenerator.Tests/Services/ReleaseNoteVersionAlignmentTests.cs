...
/// <summary>
/// Tests for <see cref="ReleaseNoteGenerator.AlignVersionWithBaseRefPrefix"/>, which keeps the
/// generated changelog link pointed at a tag that actually exists.
/// </summary>
public class ReleaseNoteVersionAlignmentTests
{
    /// <summary>
    /// A bare (unprefixed) release version used across the alignment tests.
    /// </summary>
    private const string BareVersion = "10.0.0";

    /// <summary>
    /// Tests that a bare version is given the base ref's "v" prefix so the compare link resolves.
    /// </summary>
    [Test]
    ...
    /// <summary>
    /// Tests that a version already carrying the prefix is left untouched (no double "v").
    /// </summary>
    [Test]
    ...
    /// <summary>
    /// Tests that a bare base ref leaves a bare version untouched (no prefix to infer).
    /// </summary>
    [Test]
    ...
    /// <summary>
    /// Tests that a null base ref (no previous release) leaves the version untouched.
    /// </summary>
    [Test]
    ...
    /// <summary>
    /// Tests that an uppercase "V" prefix on the base ref is preserved when applied to the version.
    /// </summary>
    [Test]
